import gym
import numpy as np
from agent.td3_agent import Agent
...
if __name__ == "__main__":
    ...
    n_epochs = 4
    alpha = 3e-4
    agent_ = Agent(batch_size=batch_size, actor_lr=1e-3, env=env,
                   critic_lr=1e-3, tau=5e-3, fc1_dim=400, fc2_dim=300, input_dims=env.observation_space.shape[0])
